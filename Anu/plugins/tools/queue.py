...
from Anu.utils import AnonyBin, get_channeplayCB, seconds_to_min
from Anu.utils.database import get_cmode, is_active_chat, is_music_playing
from Anu.utils.decorators.language import language, languageCB
from Anu.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://files.catbox.moe/10xn4h.jpg",
        caption=_["queue_1"],
    )
