...
async def get_thumb(videoid: str):
    ...
    try:
        ...
        icons = Image.open("LearningBots/assets/icons.png")
        ...
        font_info = ImageFont.truetype("LearningBots/assets/font2.ttf", 28)
        font_time = ImageFont.truetype("LearningBots/assets/font2.ttf", 26)
        font_path = "LearningBots/assets/font3.ttf"
        ...
        watermark_font = ImageFont.truetype("LearningBots/assets/font2.ttf", 24)
        watermark_text = "Team LearningBots"
